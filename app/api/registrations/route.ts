    ...
    <div style="max-width:640px; margin:0 auto; padding:40px 20px;">
      <div style="background-color:#4a4a4a; border-radius:24px; overflow:hidden; box-shadow:0 20px 60px rgba(0,0,0,0.12);">
        <div style="padding:40px 32px 24px 32px; text-align:center; border-bottom:1px solid rgba(255,255,255,0.08);">
          <img
            src="https://www.aiverkstan.nu/logo.png"
            alt="AI-verkstan"
            style="display:block; margin:0 auto 20px auto; max-width:180px; height:auto;"
          />
        ...
        <div style="padding:32px;">
          ...
          <p style="margin:0 0 20px 0; font-size:16px; line-height:1.7; color:#dddddd; font-family:Arial, sans-serif;">
...
`,
  ...
  <div style="margin:0; padding:0; background-color:#f4f1ea;">
    <div style="max-width:640px; margin:0 auto; padding:40px 20px;">
      <div style="background-color:#4a4a4a; border-radius:24px; overflow:hidden; box-shadow:0 20px 60px rgba(0,0,0,0.12);">
        <div style="padding:40px 32px 24px 32px; border-bottom:1px solid rgba(255,255,255,0.08); text-align:center;">
          <img
            src="https://www.aiverkstan.nu/logo.png"
            alt="AI-verkstan"
            style="display:block; margin:0 auto 20px auto; max-width:180px; height:auto;"
        ...
        <div style="padding:32px;">
          <p style="margin:0 0 24px 0; font-size:16px; line-height:1.7; color:#dddddd; font-family:Arial, sans-serif;">
            En ny anmälan har kommit in via formuläret på
            <a
              href="https://www.aiverkstan.nu"
              style="color:#e0b41e; text-decoration:none; font-weight:700;"
            >
          ...
          <p style="margin:24px 0 0 0; font-size:15px; line-height:1.7; color:#dddddd; font-family:Arial, sans-serif;">
            Hälsningar,<br />
